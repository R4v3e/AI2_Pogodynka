...
class ForecastController extends AbstractController
{
    ...
    #[IsGranted('ROLE_ACCESS_FORECAST_INDEX')]
    ...
    #[IsGranted('ROLE_ACCESS_FORECAST_NEW')]
    ...
    #[IsGranted('ROLE_ACCESS_FORECAST_SHOW')]
    ...
    #[IsGranted('ROLE_ACCESS_FORECAST_EDIT')]
    ...
    #[IsGranted('ROLE_ACCESS_FORECAST_DELETE')]
