...
class __TwigTemplate_12ab4475eb3b2b6fceb24edc616d1d1b extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["measurement"]) {
            // line 14
            echo "            <li>";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["measurement"], "timestamp", [], "any", false, false, false, 14), "d.m.Y"), "html", null, true);
            echo ": ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["measurement"], "temperature", [], "any", false, false, false, 14), "html", null, true);
            echo "&deg;C</li>
        ";
        }
...
<main>
    ...
    <ul>
        {% for measurement in measurements %}
            <li>{{ measurement.timestamp|date('d.m.Y') }}: {{ measurement.temperature }}&deg;C</li>
        {% endfor %}
    </ul>
</main>
{% endblock %}
", "weather/city.html.twig", "/Users/reaf/school/AplikacjeInternetowe/pogodynka/templates/weather/city.html.twig");
    }
}
