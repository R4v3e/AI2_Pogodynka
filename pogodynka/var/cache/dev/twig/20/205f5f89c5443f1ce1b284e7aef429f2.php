...
class __TwigTemplate_c63134e3d13cdafaca376be94f4d7ccc extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 9
        if ($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), 'errors')) {
            // line 10
...
";
    ...
    {
        return array (  107 => 14,  101 => 11,  98 => 10,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
", "location/new.html.twig", "/Users/reaf/school/AplikacjeInternetowe/pogodynka/templates/location/new.html.twig");
    }
}
